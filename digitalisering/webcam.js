...
window.webcam = {
	...
	swf_url: 'digitalisering/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'digitalisering/shutter.mp3', // URI to shutter.mp3 sound
	...
	freeze: function() {
		...
		setTimeout(function() {
			webcam.upload(webcam.api_url+'?sample=yes');
		}, 1000);
	...
	upload: function(url, callback) {
		...
		this.get_movie()._upload(this.api_url+'?project_id='+project_id);
	},
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'digitalisering/shutter.mp3';
	},
